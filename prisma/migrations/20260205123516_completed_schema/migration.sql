...
CREATE TABLE "Availabilty" (
    ...
    CONSTRAINT "Availabilty_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Availabilty" ADD CONSTRAINT "Availabilty_serviceId_fkey" FOREIGN KEY ("serviceId") REFERENCES "Service"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
